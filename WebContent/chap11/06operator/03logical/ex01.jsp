...
<body>
	...
	<h3>${true && true }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>
	<h3>${true && false }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>
	<h3>${false && true }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>
	<h3>${false && false }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>

<hr />

	<h3>${true and true }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>
	<h3>${true and false }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>
	<h3>${false and true }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>
	<h3>${false and false }</h3> <%-- 두 항이 모두 true일때만 결과가 true --%>
